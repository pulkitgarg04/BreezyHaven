        ...
        <header>
            <nav className="relative px-4 py-4 flex justify-between items-center">
                <a className="text-3xl font-bold leading-none" href="/">
                    <img src="breezyhaven-logo-black.png" className="h-10" alt="breezyhaven logo" />
                </a>
                ...
                <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:items-center lg:w-auto lg:space-x-6">
                    <li><a className="text-gray-400 hover:text-gray-500" href="/">Home</a></li>
                    <li><a className="text-blue-600 font-bold" href="/">Rooms</a></li>
                    <li><a className="text-gray-400 hover:text-gray-500" href="/">About Us</a></li>
                    <li><a className="text-gray-400 hover:text-gray-500" href="/">More</a></li>
                </ul>
                <div>
                    <div>
                        <FaMoon />
